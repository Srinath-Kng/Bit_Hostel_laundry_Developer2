...
import 'package:bitslaundry/Pages/order_details.dart';
import 'package:bitslaundry/Pages/orderedPage.dart';
  import 'add_address.dart';
  import 'package:bitslaundry/Components/Address_manager.dart';
...
getPhone() async{
  ...
  void initState() {
    ...
    MaterialPageRoute(builder: (context) =>AddAddress(),
              ...
              stream :  FirebaseFirestore.instance.collection('washX_users').doc(phonex).snapshots(),
                ...
                if(snapshot.connectionState == ConnectionState.waiting){
                  ...
                  return ListView.builder(
                     ...
                     print(group);
                               ...
                               FirebaseFirestore.instance.collection("washX_users").doc(phonex).update(

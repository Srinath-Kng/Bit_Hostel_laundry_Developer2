    ...
    children: <Widget>[
               ...
               Padding(
                 ...
                 child: Container(
                   ...
                   child: Image.asset('assets/bitlogo.png',height:MediaQuery.of(context).size.height/10,color: Colors.white,)),
               ),
                 ...
                 Row(
                   ...
                   children: <Widget>[
                     Text("BIT",style: TextStyle(color: Colors.white,fontSize: MediaQuery.of(context).size.height/12),),
                     Text("LAUNDRY",style: TextStyle(color: Colors.white,fontSize: MediaQuery.of(context).size.height/20,fontWeight: FontWeight.w700),),
                ...
                Padding(
                  ...
                  child: Material(
                   ...
                   new LengthLimitingTextInputFormatter(15),
                      ...
                      // }
                        //else if(_phoneNumberController.text.length!=15){
...
Padding(
  ...
  Container(
    ...
    child: Padding(
      ...
      child: Row(
          children: <Widget>[
             Text("Already have an Account ?",style :TextStyle(color: Color.fromARGB(255, 255, 255, 255))),
       FlatButton(
         onPressed: (){
                  Navigator.push(
      context,
  ...
  DocumentReference documentReference =
      await FirebaseFirestore.instance.collection("bitlaun").doc(_phoneNumberController.text);
  documentReference.get().then((datasnapshot) {


  if (datasnapshot.exists) {
  print(datasnapshot.data);
  String phone = datasnapshot['providerProfile']['phone'];
  print(phone);
